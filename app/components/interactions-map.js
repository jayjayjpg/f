...
import app from 'npm:biojs-vis-interactions-heatmap-d3';

export default Ember.Component.extend({
  classNames: ['facade-element','interactions-heatmap'],
  init(){
    this._super(...arguments);
    console.log("init interactions heatmap: " + JSON.stringify(app));
  },
  didInsertElement(){
